...
router.put('/:signalId/mark-minted',validateParams(signalIdSchema),signalsController.markSignalMinted);
router.put('/:signalId/improvements/:improvementIndex/mark-minted',validateParams(improvementIndexSchema),signalsController.markImprovementMinted);
