  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-3">
        ...
        <span className="text-sm text-neutral-500">{formatTimeframe(signal.createdAt)}</span>
      </div>
      ...
      <div className="flex space-x-2">
        {onView && (
          <button
            onClick={onView}
            className="flex-1 bg-white border border-neutral-200 text-neutral-700 py-2 px-4 rounded-md hover:bg-neutral-50 transition-colors text-sm font-medium"
          >
            View
          </button>
        )}
        {onBuy && (
          <button
            onClick={onBuy}
            className="flex-1 bg-neutral-900 text-white py-2 px-4 rounded-md hover:bg-neutral-800 transition-colors text-sm font-medium"
          >
            Buy
          </button>
        )}
        {onImprove && (
          <button
            onClick={onImprove}
            className="flex-1 bg-green-100 border border-green-200 text-green-700 py-2 px-4 rounded-md hover:bg-green-50 transition-colors text-sm font-medium"
          >
            Improve
          </button>
        )}
